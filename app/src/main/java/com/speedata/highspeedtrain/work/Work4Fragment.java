...
public class Work4Fragment extends BaseFragment {
    ...
    public static Work4Fragment newInstance() {
        Bundle args = new Bundle();
        Work4Fragment fragment = new Work4Fragment();
    ...
    private void createData() {
        ...
        infoBean7.setTitle("1#锚段关节式电分相集中修记录");
        datas.add(infoBean7);

        InfoBean infoBean8=new InfoBean();
        infoBean8.setTitle("2#锚段关节式电分相集中修记录");
        datas.add(infoBean8);

        InfoBean infoBean9=new InfoBean();
        infoBean9.setTitle("3#锚段关节式电分相集中修记录");
        datas.add(infoBean9);

        InfoBean infoBean10=new InfoBean();
        infoBean10.setTitle("交叉线集中修记录");
        datas.add(infoBean10);

        InfoBean infoBean4=new InfoBean();
        infoBean4.setTitle("1#锚段关节集中修记录");
        datas.add(infoBean4);

        InfoBean infoBean5=new InfoBean();
        infoBean5.setTitle("2#锚段关节集中修记录");
        datas.add(infoBean5);

        InfoBean infoBean6=new InfoBean();
        infoBean6.setTitle("3#锚段关节集中修记录");
        datas.add(infoBean6);

        InfoBean infoBean=new InfoBean();
        infoBean.setTitle("承力索偏移值集中修记录");
        datas.add(infoBean);

        InfoBean infoBean1=new InfoBean();
        infoBean1.setTitle("接触线集中修记录");
        datas.add(infoBean1);
        ...
        infoBean3.setTitle("分段绝缘器、分相绝缘器集中修记录");
        datas.add(infoBean3);
    }
