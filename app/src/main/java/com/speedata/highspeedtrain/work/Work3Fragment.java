...
public class Work3Fragment extends BaseFragment {

    private RVAdapter mAdapter;
    private List<InfoBean> datas;
    private RecyclerView mRvContent;

    public static Work3Fragment newInstance() {
        Bundle args = new Bundle();
        Work3Fragment fragment = new Work3Fragment();
    ...
    private void createData() {
        ...
        infoBean4.setTitle("1#锚段关节全面检查记录");
        datas.add(infoBean4);

        InfoBean infoBean5=new InfoBean();
        infoBean5.setTitle("2#锚段关节全面检查记录");
        datas.add(infoBean5);

        InfoBean infoBean6=new InfoBean();
        infoBean6.setTitle("3#锚段关节全面检查记录");
        datas.add(infoBean6);

        InfoBean infoBean7=new InfoBean();
        infoBean7.setTitle("1#锚段关节式电分相全面检查记录");
        datas.add(infoBean7);

        InfoBean infoBean8=new InfoBean();
        infoBean8.setTitle("2#锚段关节式电分相全面检查记录");
        datas.add(infoBean8);

        InfoBean infoBean9=new InfoBean();
        infoBean9.setTitle("3#锚段关节式电分相全面检查记录");
        datas.add(infoBean9);

        InfoBean infoBean10=new InfoBean();
        infoBean10.setTitle("交叉线全面检查记录");
        datas.add(infoBean10);

        InfoBean infoBean=new InfoBean();
        infoBean.setTitle("承力索偏移值全面检查记录");
        datas.add(infoBean);

        InfoBean infoBean1=new InfoBean();
        infoBean1.setTitle("接触线全面检查记录");
        datas.add(infoBean1);
        ...
        infoBean3.setTitle("分段绝缘器、分相绝缘器全面检查记录");
        datas.add(infoBean3);
